...
function getDraftSecret() {
	return "632bbd60-7db7-42bb-9395-ca83c03a022a";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "1f103135-6a4b-4526-8312-866274bd27f9";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "1f103135-6a4b-4526-8312-866274bd27f9") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "1f103135-6a4b-4526-8312-866274bd27f9",
		rootBoundaryId
	});
}
/**
