...
function getDraftSecret() {
	return "a57d7573-b294-477d-b588-cae580caa983";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "f1d38524-0449-4478-81e8-e8405855007e";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "f1d38524-0449-4478-81e8-e8405855007e") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "f1d38524-0449-4478-81e8-e8405855007e",
		rootBoundaryId
	});
}
/**
