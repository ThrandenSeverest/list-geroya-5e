...
function getDraftSecret() {
	return "a793ff44-759f-44c7-907d-314568ce5664";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "1165d223-3d18-4ba1-b4ed-8a352e1764ae";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "1165d223-3d18-4ba1-b4ed-8a352e1764ae") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "1165d223-3d18-4ba1-b4ed-8a352e1764ae",
		rootBoundaryId
	});
}
/**
