...
function getDraftSecret() {
	return "23a5586d-52f4-4eac-bb43-c79f59aefbf7";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "dc22e200-538e-4043-afc8-782d0eb92897";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "dc22e200-538e-4043-afc8-782d0eb92897") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "dc22e200-538e-4043-afc8-782d0eb92897",
		rootBoundaryId
	});
}
/**
