...
function getDraftSecret() {
	return "5f41448d-44ce-43d8-b5ba-c212b133e485";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "75bb8e89-20ab-4887-807d-ddf1d7397648";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "75bb8e89-20ab-4887-807d-ddf1d7397648") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "75bb8e89-20ab-4887-807d-ddf1d7397648",
		rootBoundaryId
	});
}
/**
