...
function getDraftSecret() {
	return "41eb5051-927d-4a66-8a34-948bafb9b404";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "97aeb459-cc17-45c2-85a8-2611f345f2d4";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "97aeb459-cc17-45c2-85a8-2611f345f2d4") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "97aeb459-cc17-45c2-85a8-2611f345f2d4",
		rootBoundaryId
	});
}
/**
