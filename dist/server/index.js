...
function getDraftSecret() {
	return "af81234c-0beb-445b-8a13-04f3a965b757";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "384f6050-5d75-4489-9614-ef0e890e2403";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "384f6050-5d75-4489-9614-ef0e890e2403") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "384f6050-5d75-4489-9614-ef0e890e2403",
		rootBoundaryId
	});
}
/**
