...
function getDraftSecret() {
	return "e17dfa59-fdbd-4e14-9d77-a47b9e38183a";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "b0926e9f-efdd-439d-8b0a-74ba95ef7277";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "b0926e9f-efdd-439d-8b0a-74ba95ef7277") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "b0926e9f-efdd-439d-8b0a-74ba95ef7277",
		rootBoundaryId
	});
}
/**
