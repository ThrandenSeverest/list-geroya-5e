...
function getDraftSecret() {
	return "cce3e013-eea8-4c15-941c-27d466db069b";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "74013ca1-cb50-40a7-87f9-13829ef8c802";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "74013ca1-cb50-40a7-87f9-13829ef8c802") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "74013ca1-cb50-40a7-87f9-13829ef8c802",
		rootBoundaryId
	});
}
/**
