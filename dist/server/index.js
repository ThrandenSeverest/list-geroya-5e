...
function getDraftSecret() {
	return "b94fced1-afbd-4287-85d4-c6341420e483";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "d0ab78e6-5d30-43de-981e-b62a653896bf";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "d0ab78e6-5d30-43de-981e-b62a653896bf") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "d0ab78e6-5d30-43de-981e-b62a653896bf",
		rootBoundaryId
	});
}
/**
