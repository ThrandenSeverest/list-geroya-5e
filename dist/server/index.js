...
function getDraftSecret() {
	return "06037470-b409-47ee-8e46-304dcf763335";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "984f975a-571e-4829-b276-e0c3a7093fac";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "984f975a-571e-4829-b276-e0c3a7093fac") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "984f975a-571e-4829-b276-e0c3a7093fac",
		rootBoundaryId
	});
}
/**
