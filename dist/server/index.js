...
function getDraftSecret() {
	return "0d830700-e7bb-4069-b9fd-0d42abbe0b35";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "a5f14d61-4f76-4c3b-bc46-ec76c513a405";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "a5f14d61-4f76-4c3b-bc46-ec76c513a405") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "a5f14d61-4f76-4c3b-bc46-ec76c513a405",
		rootBoundaryId
	});
}
/**
