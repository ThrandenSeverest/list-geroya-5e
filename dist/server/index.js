...
function getDraftSecret() {
	return "305bde51-a4b9-4e94-a9a1-b08f9b470a7d";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "b4ea0025-a661-4d6e-8297-c8e809eba4cc";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "b4ea0025-a661-4d6e-8297-c8e809eba4cc") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "b4ea0025-a661-4d6e-8297-c8e809eba4cc",
		rootBoundaryId
	});
}
/**
