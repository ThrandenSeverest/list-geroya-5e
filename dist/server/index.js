...
function getDraftSecret() {
	return "bcff664d-a1ef-4309-ba94-1b6020196f0e";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "bd830d85-e3b9-4e7e-a641-3ae87d153832";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "bd830d85-e3b9-4e7e-a641-3ae87d153832") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "bd830d85-e3b9-4e7e-a641-3ae87d153832",
		rootBoundaryId
	});
}
/**
