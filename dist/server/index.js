...
function getDraftSecret() {
	return "0f77ad0e-dbc7-437d-a72b-71e723c25281";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "85ecbc2f-f7f3-464e-92ab-31c4ddd4e256";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "85ecbc2f-f7f3-464e-92ab-31c4ddd4e256") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "85ecbc2f-f7f3-464e-92ab-31c4ddd4e256",
		rootBoundaryId
	});
}
/**
