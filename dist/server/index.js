...
function getDraftSecret() {
	return "00865845-c53a-463b-a93e-8b195e1d5e2a";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "9e2aaa74-0524-4c10-93cf-5ca558c403cd";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "9e2aaa74-0524-4c10-93cf-5ca558c403cd") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "9e2aaa74-0524-4c10-93cf-5ca558c403cd",
		rootBoundaryId
	});
}
/**
