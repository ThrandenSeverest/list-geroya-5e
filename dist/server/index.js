...
function getDraftSecret() {
	return "bde57c86-1a52-4071-9871-eb50a2085b3d";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "1db5610c-7d8a-41a2-9faf-ba23d7c46433";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "1db5610c-7d8a-41a2-9faf-ba23d7c46433") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "1db5610c-7d8a-41a2-9faf-ba23d7c46433",
		rootBoundaryId
	});
}
/**
