...
function getDraftSecret() {
	return "2b3486fa-3b4f-4ba8-aaba-32e8bf09cf90";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "03857df4-ecbb-4344-955a-2a6a296331c8";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "03857df4-ecbb-4344-955a-2a6a296331c8") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "03857df4-ecbb-4344-955a-2a6a296331c8",
		rootBoundaryId
	});
}
/**
