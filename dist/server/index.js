...
function getDraftSecret() {
	return "9d5fe8cc-8e1c-40f4-a75d-a94807798d53";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "3dc7ab9f-f0b3-4830-a969-42dfdd15f4ab";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "3dc7ab9f-f0b3-4830-a969-42dfdd15f4ab") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "3dc7ab9f-f0b3-4830-a969-42dfdd15f4ab",
		rootBoundaryId
	});
}
/**
