		...
		try {
			...
			while (Date.now() < deadline) {
				...
				if (status.status === "confirmed" && status.token) {
					const complete = await fetch(linkExisting ? "/api/auth/external/link" : "/api/auth/external/complete", {
						method: "POST",
						headers: { "content-type": "application/json" },
	...
	return /* @__PURE__ */ jsxs("main", {
		...
		children: [/* @__PURE__ */ jsx(Link, {
			...
			children: [
				...
				/* @__PURE__ */ jsx("h1", { children: account?.legacyRecovery ? "Перенос старого аккаунта" : account?.authenticated ? "Ваш аккаунт" : mode === "register" ? "Создать аккаунт" : mode === "forgot" ? "Забыли пароль?" : mode === "reset" ? "Новый пароль" : mode === "legacy" ? "Доступ к старому аккаунту" : "Войти" }),
				account?.legacyRecovery ? /* @__PURE__ */ jsxs("div", {
					className: "auth-profile",
					children: [
						/* @__PURE__ */ jsxs("p", { children: [
							/* @__PURE__ */ jsx("b", { children: "Старый аккаунт:" }),
							" ",
							account.email
						] }),
						/* @__PURE__ */ jsx("p", { children: "Обычная запись отключена. Сначала скачайте полную резервную копию, затем привяжите Telegram. Персонажи и хоумбрю останутся у того же аккаунта." }),
						/* @__PURE__ */ jsx("a", {
							className: "primary-action",
							href: "/api/legacy/export",
							download: true,
							children: "Скачать персонажей и хоумбрю"
						}),
						/* @__PURE__ */ jsx("button", {
							type: "button",
							className: "primary-action",
							disabled: busy,
							onClick: () => loginTelegram(true),
							children: "Привязать Telegram и продолжить"
						}),
						messengerLink && /* @__PURE__ */ jsx("p", { children: /* @__PURE__ */ jsx("a", {
							href: messengerLink,
							target: "_blank",
							rel: "noopener noreferrer",
							children: "Открыть Telegram и подтвердить привязку"
						}) }),
						/* @__PURE__ */ jsx("button", {
							onClick: logout,
							children: "Выйти"
					...
					children: [
						...
						account.authProvider === "email" && !account.linkedProviders?.includes("telegram") && /* @__PURE__ */ jsx("button", {
							type: "button",
							className: "primary-action",
							disabled: busy,
							onClick: () => loginTelegram(true),
							children: "Привязать Telegram без потери персонажей"
						}),
						account.linkedProviders?.includes("telegram") && /* @__PURE__ */ jsxs("p", { children: [/* @__PURE__ */ jsx("b", { children: "Telegram:" }), " привязан. Через него открывается эта же коллекция персонажей."] }),
						messengerLink && /* @__PURE__ */ jsx("p", { children: /* @__PURE__ */ jsx("a", {
							href: messengerLink,
							target: "_blank",
							rel: "noopener noreferrer",
					...
					/* @__PURE__ */ jsxs("form", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("button", {
								className: "primary-action",
								disabled: busy,
								children: busy ? "Подождите…" : mode === "register" ? "Зарегистрироваться" : mode === "forgot" ? "Отправить ссылку" : mode === "reset" ? "Сменить пароль" : mode === "legacy" ? "Открыть восстановление" : "Войти"
							})
						]
					}),
					/* @__PURE__ */ jsxs("nav", {
						...
						children: [
							...
							mode !== "legacy" && /* @__PURE__ */ jsx("button", {
								onClick: () => setMode("legacy"),
								children: "Перенести старый E-mail аккаунт"
							})
						]
					})
				] }),
