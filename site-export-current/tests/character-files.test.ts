...
assert.deepEqual(lssCards.character.lssSpellCards, {
  mode: "cards", prepared: cardPrepared, book: cardBook, edition: "2014", resolved: {},
});
assert.match(lssCards.warnings[0], /3 закрытых ID не содержат ссылки/);
