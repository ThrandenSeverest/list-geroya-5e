...
function getDraftSecret() {
	return "a99acd22-cbfc-425e-90e7-8f385f71136d";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "d207cf83-578b-4909-b21f-cf5a25a5376f";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "d207cf83-578b-4909-b21f-cf5a25a5376f") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "d207cf83-578b-4909-b21f-cf5a25a5376f",
		rootBoundaryId
	});
}
/**
