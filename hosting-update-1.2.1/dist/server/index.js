...
function getDraftSecret() {
	return "fe80d1aa-6aa3-47c7-b229-42314211028d";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "e5d9e855-c098-49d0-b88a-a594ee9a4901";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "e5d9e855-c098-49d0-b88a-a594ee9a4901") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "e5d9e855-c098-49d0-b88a-a594ee9a4901",
		rootBoundaryId
	});
}
/**
